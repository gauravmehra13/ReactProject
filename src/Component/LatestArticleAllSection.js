...
const LatestArticlesAllSection = () => {
            ...
            if (index >= technology.length - 1) {
              return (
                <div key={index} className={styles.AllSections_Card}>
                  <div>
                    <img
                      className={styles.AllSections_Image}
                  ...
                  <div>
                    ...
                    <span className={styles.AllSections_PublishedDate}>
                      {" "}
...
export default LatestArticlesAllSection;